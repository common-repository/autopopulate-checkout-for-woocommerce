...
if ( ! empty( $atts['label'] ) ) {
	...
	?><label for="<?php echo esc_attr( $atts['id'] ); ?>"><?php esc_html_e( $atts['label'], 'pixelforms' ); ?>: </label><?php
...
if ( ! empty( $atts['description'] ) ) {
	...
	?><span class="description"><?php esc_html_e( $atts['description'], 'pixelforms' ); ?></span><?php
